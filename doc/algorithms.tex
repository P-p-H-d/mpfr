...
Now, we substitute the power series into the ODE computng each term separately.
...
As an example, here's the first term reindexed
$y'' = \sum_{k=0}^{\infty} (k+2)(k+1)c_{k+2} x^k$. Therefore
the equation becoms
\begin{align*}
...
In order to get the first two coefficients of even degrees, we set $k = 1$
in Equation \ref{eq:legendre-ode-recurrence}, and we get
$(3)(2)c_3 = \big(1 \cdot 2 - n(n+1)\big)c_1$. Hence,
\begin{align*}
  \frac{c_3}{c_1}              &= \frac{2 - n(n+1)}{6} \\
  \left|\frac{c_3}{c_1}\right| &= \frac{n(n+1) - 2}{6} \\
                               &\le \frac{n(n+1)}{6}   \\
                               &\le \frac{n^2}{3},~\mathrm{for}~n>1.
\end{align*}

Now we do the same for the first two coefficients of even degrees, setting $k = 0$
n Equation \ref{eq:legendre-ode-recurrence}, and we get 
$(2)(1)c_2 = - n(n+1)c_0$. Hence,
\begin{align*}
  \frac{c_2}{c_0}              &= -\frac{n(n+1)}{2} \\
  \left|\frac{c_2}{c_0}\right| &= \frac{n(n+1)}{2}  \\
                               &\le n^2,~\mathrm{for}~n>1.
\end{align*}
